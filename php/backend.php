<?php
	...
	$application_obj->Myconnection ($connection_mock_chat,"localhost","root","test");
	...
	elseif ($_POST['request']=='search')
	{
	    ...
	    $value=array(array('string','mock_test_tbl','Name','Name as name,Id as id,Email as email,Phone as phone,Gender as gender','id'), array('email','mock_test_tbl','Email','Name as name,Id as id,Email as email,Phone as phone,Gender as gender','id'));
	    $query_data=array();
